    ...
    public partial class mg1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderSizes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    OrderSizeId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Orders_OrderSizes_OrderSizeId",
                        column: x => x.OrderSizeId,
            ...
            migrationBuilder.InsertData(
                table: "OrderSizes",
                columns: new[] { "Id", "PriceMultiplier", "Size" },
                values: new object[,]
                {
                    { 1, 1m, "Small" },
                    { 2, 1.4m, "Medium" },
